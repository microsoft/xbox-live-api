...
#pragma warning(suppress: 6387)
    ...
    */
    ...
    DEFINE_TEST_CASE(TestJoinGameFromLobbyWithTransferHandleMultipleUsers)
    {
        ...
        xboxLiveContext2->User->GetUserImpl()->_Set_xbox_user_id(L"TestXboxUserId_2");
...
#pragma warning(suppress: 6387)
    ...
    DEFINE_TEST_CASE(TestMultipleLocalUsers_2)
    {
        ...
        xboxLiveContext3->User->GetUserImpl()->_Set_xbox_user_id(L"TestXboxUserId_3");
    ...
    DEFINE_TEST_CASE(TestMultipleLocalUsers_3)
    {
        ...
        xboxLiveContext4->User->GetUserImpl()->_Set_xbox_user_id(L"TestXboxUserId_4");
        auto xboxLiveContext5 = GetMockXboxLiveContext_WinRT();
        xboxLiveContext5->User->GetUserImpl()->_Set_xbox_user_id(L"TestXboxUserId_5");
