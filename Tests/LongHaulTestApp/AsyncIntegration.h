...
HANDLE InitializeAsync(_In_ async_queue_handle_t queue, _In_ LPTHREAD_START_ROUTINE thread, _In_ LPVOID threadContext, _Out_ registration_token_t* callbackToken);
