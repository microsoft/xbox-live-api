...
DWORD WINAPI xbox_live_thread_proc_c(LPVOID lpParam)
{
...
HC_RESULT libhttpclient_event_handler_c(
...
{
    //HCAddTaskEventHandler(HC_SUBSYSTEM_ID_XSAPI, this, libhttpclient_event_handler_c, &m_hcEventHandle);

    //for (int i = 0; i < m_targetNumThreads; i++)
    //{
    //    m_hActiveThreads[i] = CreateThread(nullptr, 0, xbox_live_thread_proc_c, this, 0, nullptr);
