    ...
    )
{
    ...
    auto result = xboxLiveContext->pImpl->cppObject()->social_service_impl()->get_social_relationships(
...
try
{
    return XblGetSocialRelationshipsHelper(
        xboxLiveContext,
        xboxLiveContext->pUser->xboxUserId,
...
try
{
    ...
    auto result = xboxLiveContext->pImpl->cppObject()->social_service_impl()->subscribe_to_social_relationship_change(xboxUserId);
    if (!result.err())
    {
...
try
{
    ...
    return utils::create_xbl_result(
        xboxLiveContext->pImpl->cppObject()->social_service_impl()->unsubscribe_from_social_relationship_change(
...
try
{
    return xboxLiveContext->pImpl->cppObject()->social_service_impl()->add_social_relationship_changed_handler(
...
try
{
    xboxLiveContext->pImpl->cppObject()->social_service_impl()->remove_social_relationship_changed_handler(handlerFunctionContext);
}
CATCH_RETURN_WITH(;)
    ...
    ) XBL_NOEXCEPT
{
    ...
    xboxLiveContext->pImpl->cppObject()->reputation_service_impl()->submit_reputation_feedback(
        xboxUserId,
    ...
    ) XBL_NOEXCEPT
{
    ...
    xboxLiveContext->pImpl->cppObject()->reputation_service_impl()->submit_batch_reputation_feedback(
        internalItems,
        taskGroupId,
        [callback, callbackContext](xbox_live_result<void> result)
    {
