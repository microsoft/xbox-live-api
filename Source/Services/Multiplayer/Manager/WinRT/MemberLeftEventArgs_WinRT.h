...
internal:
    MemberLeftEventArgs(
        _In_ std::shared_ptr<xbox::services::multiplayer::manager::member_left_event_args> cppObj
        );

    std::shared_ptr<xbox::services::multiplayer::manager::member_left_event_args> GetCppObj() const;

private:
    std::shared_ptr<xbox::services::multiplayer::manager::member_left_event_args> m_cppObj;
