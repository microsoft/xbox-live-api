...
#define NAMESPACE_MICROSOFT_XBOX_SERVICES_STAT_MANAGER_BEGIN         NAMESPACE_MICROSOFT_XBOX_SERVICES_BEGIN NAMESPACE_MICROSOFT_XBOX_SERVICES_EXPERIMENTAL_BEGIN namespace Stats { namespace Manager {
#define NAMESPACE_MICROSOFT_XBOX_SERVICES_STAT_MANAGER_END           NAMESPACE_MICROSOFT_XBOX_SERVICES_END NAMESPACE_MICROSOFT_XBOX_SERVICES_EXPERIMENTAL_END } }
